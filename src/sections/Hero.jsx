...
const Hero = () => {
  return (
    ...
    <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
      ...
      <p className="text-slate-gray font-montserrat mt-6 mb-14 text-lg leading-8 sm:max-w-sm">Discover stylish Nike arrivals, qualirt comfort and innovation for your active life.</p>
